		...
		readDatafeed: function(url, callback) {
			var request = http.get(url, function(response) {
				...
				response.on('end', function() {
					var parsedData = datafeedReader.parseDatafeed(body);
					winston.info('Data read: ' + parsedData.general.update + ' clients: ' + parsedData.general.connectedclients + ' parsed clients: ' + parsedData.clients.length);
